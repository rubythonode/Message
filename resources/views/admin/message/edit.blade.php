<div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
        ...
        <button type="button" class="btn btn-default btn-sm" data-action='CANCEL' data-load-to='#message-message-entry' data-href='{{trans_url('admin/message/message')}}/{{$message->getRouteKey()}}'><i class="fa fa-times-circle"></i> {{ trans('cms.cancel') }}</button>
